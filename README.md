本作品集收录 12 个项目——**核心项目 6 个**（企业实践与学术研究）+ **个人实践 5 个** + **内容运营 1 个**，横跨 **AI 语音产品、Agent 工作流、数据中台与训练数据生产、RAG 知识库、金融量化建模**五条主线。既有从 0 到 1 的产品设计与架构方案，也有牵头 20+ 人团队完成的两年期学术研究，以及可复现实测的个人开源实现。
...
**技能标签**：需求分析、信息架构设计、MVP 验证、AI Agent、RAG、LLM 评测、语音产品、数据标注与后训练、金融风控合规、供应链数字化、内容策略与账号运营、Python、R、TypeScript、Go、Docker、Git、Claude Code、Codex
...
⑫ 归档的是**已公开发布的内容作品**——企业官方账号与官网物料（任职期间负责，已对外展示）及个人自媒体账号，链接可直接访问，不含内部数据与未公开资料。
