...
> 金融工程学士（国内财经类高校）· 管理科学与工程（人工智能方向）硕士（QS20 海外高校）

金融工程本科 + 人工智能方向硕士，三段 AI 产品经理实习覆盖**跨境语音、期货合规、供应链**三类业务场景。这个作品集收录 5 个项目，横跨 **AI 语音产品、Agent 工作流、RAG 知识库、金融量化建模**四条主线——既有从 0 到 1 的产品设计，也有牵头 20+ 人团队完成的两年期学术研究。
